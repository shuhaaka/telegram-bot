        ...
        <tr>
            ...
            <td>
                <label><input type="checkbox" value="1" id="ithemessecurity_new_blacklisted_ip_notification"
                              name="ithemessecurity_new_blacklisted_ip_notification" <?php checked($this->get_option('ithemessecurity_new_blacklisted_ip_notification', 0), 1) ?>> <?php _e('Active', $this->plugin_key) ?>
                </label>
            </td>
        </tr>
        <?php
