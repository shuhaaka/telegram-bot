...
class WPUserAvatarWPTP extends TelegramBot
{
    ...
    function avatar_change_notification($meta_id, $user_id, $meta_key, $meta_value)
    {
        ...
        $text = apply_filters('telegrambot_wpuseravatar_avatar_change_notification_text', $text, $meta_id, $user_id, $meta_key, $meta_value);
